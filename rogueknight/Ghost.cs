...
namespace RogueKnight
{
    ...
    public class Ghost : MovingElement
    {
        ...
        public void MoveGhost()
        {
            ...
            {
                xDir = 0; yDir = dotY; //Assign the non-absolute dot value for up direction, since it will have negative value if player is opposite direction, shooting ray in that direction instead
            }
            else
            {
                xDir = dotX; yDir = 0;
