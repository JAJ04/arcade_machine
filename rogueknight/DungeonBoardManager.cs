...
namespace RogueKnight 
{
        ...
        public void SetupDungeon(int level) 
	{
            ...
            int ghostCount = (int) Mathf.Log(level, 2 f);
            ...
            Instantiate(nextDungeon, new Vector3(cols - 1, rows - 8, 0 f), Quaternion.Euler(0, 0, 180));
        }
                ...
                for (int y = -1; y < rows + 1; y++) 
		{
                    ...
                    if (x == -1 || x == cols || y == -1 || y == rows) 
		    {
                    ...
                    GameObject instance = Instantiate(randomTileInstantiation,
                        new Vector3(x, y, 0 f), Quaternion.identity) as GameObject;
        ...
        void InitialiseDungeonTilesList() 
	{
                ...
                for (int y = 1; y < rows - 1; y++) 
		{
                    ...
                    dungeonTilesPositions.Add(new Vector3(x, y, 0 f));
                }
            }
        }
